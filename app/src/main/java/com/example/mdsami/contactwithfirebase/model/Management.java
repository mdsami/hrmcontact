...
public class Management {
    ...
    public Management(String eid, String name, String email, String password, String address, String phone, String phoneofc, String phonehome, String gender, String bloodgroup, String depaerment, String propic, String type) {
        this.eid = eid;
        this.name = name;
        this.email = email;
